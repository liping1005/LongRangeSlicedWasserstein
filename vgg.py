...
#this model is taken from https://github.com/leongatys/PytorchNeuralStyleTransfer
class VGG(nn.Module):
    def __init__(self, pool='avg'):
        super(VGG, self).__init__()
        #vgg modules
        self.pad1_1 = nn.ReflectionPad2d(1)
        self.conv1_1 = nn.Conv2d(3, 64, kernel_size=3, padding=0)
        self.pad1_2 = nn.ReflectionPad2d(1)
        self.conv1_2 = nn.Conv2d(64, 64, kernel_size=3, padding=0)
        self.pad2_1 = nn.ReflectionPad2d(1)
        self.conv2_1 = nn.Conv2d(64, 128, kernel_size=3, padding=0)
        self.pad2_2 = nn.ReflectionPad2d(1)
